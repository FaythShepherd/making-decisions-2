...
//Code Here
const letItemRemoved = arr.splice(arr.length - 1, 1)
//const lastItemPopped = arr.pop()

console.log(arr);
console.log(letItemRemoved);
//console.log(lastItemPopped);
...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,34];
// Do not edit the code above.
...
// the $ sign makes the string able to take in variables, in other words making it dynamic. You also need the curly brackets
////////// PROBLEM 9 //////////
// Do not edit the code below.
